//! Numerical integration using the double exponential algorithm.
//!
//! The double exponential algorithm is naturally adaptive, it stops calling the integrand
//! when the error is reduced to below the desired threshold. It also does not allocate.
//!
//! It has a hard coded maximum of approximately 350 function evaluations.
//! The error in the algorithm decreases exponentially in the number of function evaluations,
//! specifically O(exp(-cN/log(N))).
//!
//! This code is adapted from `quadrature` https://github.com/Eh2406/quadrature
//! and the diffusers-rs implementation.

#[cfg(not(feature = "std"))]
#[allow(unused_imports)]
use num_traits::Float;

/// Output from numerical integration.
...
/// * `target_absolute_error` - Target absolute error for the result
    ...
    F: Fn(f64) -> f64,
{
    ...
    let mut integral = 2.0 * FRAC_PI_2 * f(0.0);
...
/// Weights and abscissas for the double exponential quadrature rule.
pub const WEIGHTS: [&[(f64, f64)]; 7] = [
    ...
    &[
        // 2nd layer weights and abscissas
    ...
    &[
        // 3rd layer weights and abscissas
    ...
    &[
        // 4th layer weights and abscissas
    ...
    &[
        // 5th layer weights and abscissas
    ...
    &[
        // 6th layer weights and abscissas
    ...
    &[
        // 7th layer weights and abscissas
...
mod tests {
    ...
    fn test_integrate_constant() {
        ...
        let result = integrate(|_| 1.0, 0.0, 1.0, 1e-10);
    ...
    fn test_integrate_linear() {
        ...
        let result = integrate(|x| x, 0.0, 1.0, 1e-10);
        assert!((result.integral - 0.5).abs() < 1e-8);
    }
